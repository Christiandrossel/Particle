...
public class _06_WasserdynamikShader {
	...
	public static void main(String[] args) throws LWJGLException {
		try {						
			...
			String fragShader_waterDynamic_and_texture_1 = 
				"uniform sampler2D tex1;"+
				"uniform sampler2D tex2;" +
				"" +
				"uniform vec2 s;"+
				...
				"	vec4 col = dev;" +
				"	if (col.x <= 0)" +
				"		col *= -vec4(1f, 1f, 0f, 1f) * 5.0f;" +
				"	else " +
				"		col *=  vec4(0f, 1f, 0f, 1f) * 5.0f;" +				
				"	gl_FragColor = col;" +
				"}";			
			
			int shaderObjectF2 = glCreateShader(GL_FRAGMENT_SHADER);
			glShaderSource(shaderObjectF2, fragShader_waterDynamic_and_texture_1);
			...
			int tex2Loc2 	= glGetUniformLocation(program_WasserDynamik_auf_Texture, "tex2");
